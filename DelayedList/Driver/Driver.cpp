...
#define STR_DELAY_TAG   'DrtS'
#define STR_DELAY_TIME  5
...
OnDriverUnload(IN PDRIVER_OBJECT  pDriverObj)
{
    ...
    KdPrint(("DelayedList.sys >> OnDriverUnload\n"));
         ...
         PIRP           pIrp)
{
    ...
    KdPrint(("DelayedList.sys >> OnCreate\n"));
          ...
          PIRP              pIrp)
{
    ...
    KdPrint(("DelayedList.sys >> OnCleanup\n"));
...
OnClose(PDEVICE_OBJECT  pDeviceObj,
        PIRP            pIrp)
{
    KdPrint(("DelayedList.sys >> OnClose\n"));
       ...
       IN PIRP            pIrp)
{
    ...
    KdPrint(("DelayedList.sys >> OnRead\n"));
        ...
        IN PIRP            pIrp)
{
    ...
    KdPrint(("DelayedList.sys >> OnWrite\n"));
            ...
            PUNICODE_STRING pusRegistryPath)
{
    ...
    KdPrint(("DelayedList.sys >> DriverEntry\n"));
